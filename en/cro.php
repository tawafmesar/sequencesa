...
<h1 class="org" data-aos="zoom-in-down">Management and organization of events</h3>
      <div class="container">
        <div class="info">
          ...
          <p class="title text-white" style=" line-height: 1.5;" data-aos="zoom-in-down">

            We offer the most prominent solutions to plan, design and visitor experience and implement them with solutions commensurate with the quality
            Event and target audience We also manage traffic operations and registration area
            We also maintain occupational safety and health in events . <br><br>
            We provide a strong team and experts in filling management, and they work according to tight plans
            It defines the roles and responsibilities of all event staff and includes the overall structure
            management, procedures, principles and directives.
            </p>
        </div>
