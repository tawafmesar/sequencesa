...
تنظيم المعارض والمؤتمرات
      ...
      <div class="container">
        <div class="info">
          ...
          <p class="title text-white" style=" line-height: 1.5;"  data-aos="zoom-in-up" style="text-align: right;">
            نخطط للحدث ، نعد جميع التفاصيل التشغيلية والتقنية
        نصمم وننفذ مساحات ابادعية مميزة لمعارض عملائنا
        نوفر شاشات العرض الضخمة ، انظمة الصوت ، انظمة الاضاءة المتقدمة
        اللوحات الخارجية والداخلية الالكترونية ، الخدمات اللوجستية للفعاليات والمؤتمرات .
      </p>
        </div>
